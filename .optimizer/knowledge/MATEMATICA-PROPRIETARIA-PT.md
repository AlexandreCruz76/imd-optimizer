# Proprietary Math Protection

## Strategy: Off-Chain Verification

Core mathematical models are kept **off-chain** to protect intellectual property.
...
```
✅ OptimizerVault — Deposit/withdrawal logic
...
│                                                         │
│  3. Signed transaction returns to on-chain              │
...
| Parameters | Not visible on blockchain |
...
- **Patent:** Consider patenting novel MEV capture methods
