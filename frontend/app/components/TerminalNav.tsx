...
const links = [
  ...
  { href: "/migration", label: "MIGRATE", shortcut: "F5" },
  { href: "/lp", label: "LP SIM", shortcut: "F6" },
  { href: "/burns", label: "BURNS", shortcut: "F7" },
  { href: "/subscribe", label: "SUBSCRIBE", shortcut: "F8" },
  { href: "/vault", label: "VAULT", shortcut: "F9" },
  { href: "/adoption", label: "ADOPT", shortcut: "F10" },
  { href: "/docs", label: "DOCS", shortcut: "F11" },
  { href: "/admin", label: "ADMIN", shortcut: "F12" },
];
